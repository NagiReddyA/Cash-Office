...
@NgModule({
  ...
  declarations: [
    ...
    PaypointComponent ,BiboComponent,pxsuffix,DateformatecustomComponent,Policystatusidcustompipe,TpaypointComponent
  ],entryComponents: [
    PaypointComponent,BiboComponent,TpaypointComponent
  ],
  providers:[AdminService,BsModalService, PagerService,AllocationsService],
  exports:[PaypointComponent,TpaypointComponent]
})
