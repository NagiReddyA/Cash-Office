...
import { CountryDenominationComponent} from './country-denomination.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'country-denomination',
        component: CountryDenominationComponent,
        data: {
          title: 'Country Denomination' 
        }
      },
      {
        path: '**',
